...
function updateLoginButton(useravatar,username) {
  ...
  const token = localStorage.getItem('token');
    ...
    console.log("用户头像是useravatar:", useravatar);
    if(token){
    if (useravatar==null ) {useravatar = 'default_avater.png';}
        // 显示用户名和下拉菜单
                ...
                <div class="username-container">
                    ...
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="./model/upload_word/upload_word.html">我的合同</a></li>
                            <li><a href="./model/manage/manage.html">好友</a></li>
